    ...
    <header>
      <div class="grid">
        <div>
          ...
          <p>Search the æternity blockchain by block, transaction, address. Or go through the last changes or stats.</p>
        </div>
        <div class='search'>
...
<style>
.index-screen header {
  background-image: linear-gradient(-134deg, #6F53A1 0%, #311B58 100%);
  color: #FFFFFF;
  padding-bottom:200px;
}
.index-screen header h1 {
  font-size:50px;
  font-weight:500;
  margin:0;
}
.index-screen header .grid {
...
.index-screen header .grid > * > :last-child {
  margin-bottom:0;
}
.index-screen header .grid .search {
  display:flex;
...
.search-input {
  ...
  border-radius: 100px 0 00px 100px;
  width:100%;
...
.index-screen .market-stats-partial{
